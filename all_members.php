    ...
    <section class="container-fluid mt-2 mb-5">
        ...
        <div>
            <div class="row mb-2 mt-2 button" style="background: linear-gradient(180deg, #E2C448, #BF8944);color: aliceblue;padding: 10px;border-radius: 30px;">
                <div class="col-2">
                    <p class="text-center mt-3">Member ID</p>
                </div>
                <div class="col-2">
                    <p class="text-center mt-3">Joined</p>
                </div>
                <div class="col-2">
                    <p class="text-center mt-3">Name</p>
                </div>
                <div class="col-2">
                    <p class="text-center mt-3">Level</p>
                </div>
                <div class="col-2">
                    <p class="text-center mt-3">Status</p>
                </div>
                <div class="col-2">
        ...
        <div class="card">
            ...
            <div class="row mb-2 mt-2">
                <div class="col-2">
                    <p class="text-center mt-3">2586</p>
                </div>
                <div class="col-2">
                    <p class="text-center mt-3">12/6/16</p>
                </div>
                <div class="col-2">
                    <p class="text-center mt-3">David</p>
                </div>
                <div class="col-2">
                    <p class="text-center mt-3 text-success">3</p>
                </div>
                <div class="col-2">
                    <p class="text-center mt-3 text-danger">Active</p>
                </div>
